<template>
  <div id="bank-accounts" class="card mt-4">
    <div class="card-header pb-0 p-3">
      ...
      <p class="text-sm">
        Administra tus cuentas bancarias, estas se usaran como para recibir depósitos de los
        contratos
      </p>
    </div>
    <div class="card-body p-3">
      <div class="row">
        <div v-for="(cuenta, index) in cuentasOrdenadas" :key="index" class="col-md-6 mb-md-0 mb-4">
          <div class="card border card-plain border-radius-lg mb-3">
            <div class="card-body d-flex align-items-center flex-row">
              <img :src="getBankLogo(cuenta.banco)" alt="logo" class="w-10 me-3 mb-0" />
              <div>
            ...
            >
              <div class="card-body border-top">
                ...
                <div class="d-flex">
                  ...
                  <material-button class="mb-0" color="dark" size="sm" variant="outline">
                    Editar
                  </material-button>
                </div>
