<template>
  <div id="basic-info" class="card mt-4">
    ...
    <div class="card-body pt-0">
      <div v-if="perfil" class="accordion" id="basicInfoAccordion">
        <!-- Datos del Usuario -->
        <profile-accordion-item
          accordion-id="headingUser"
          collapse-id="collapseUser"
        >
        ...
        <!-- Datos de la Empresa -->
        <profile-accordion-item
          accordion-id="headingCompany"
          collapse-id="collapseCompany"
        >
        ...
        <profile-accordion-item
          accordion-id="headingRepAddress"
          collapse-id="collapseRepAddress"
        >
