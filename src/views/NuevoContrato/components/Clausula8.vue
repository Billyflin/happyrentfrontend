  ...
  <div class="row align-items-center">
    <div class="col-9">
      <div class="row">
        ...
        <div class="col-2">
          <material-checkbox id="editClausula8" v-model="store.clausula8edit">Editar</material-checkbox>
        </div>
      </div>
      <div class="mb-3 mt-3 ms-3">
        <p ref="Clausula8" :contenteditable="store.clausula8edit" class="text-justify">
...
export default {
  ...
  watch: {
    'this.$refs.Clausula8': {
      handler(newVal) {
        if (newVal) {
          this.store.clausula8 = newVal.innerText;
        }
      },
      deep: true,
      immediate: true
  ...
  mounted() {
    if (this.$refs.Clausula8) {
      this.store.clausula8 = this.$refs.Clausula8.innerText;
    }
  }
}
</script>