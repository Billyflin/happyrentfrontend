  ...
  <div class="row align-items-center">
    <div class="col-9">
      <div class="row">
        ...
        <div class="col-2">
          <material-checkbox id="editClausula9" v-model="store.clausula9edit">Editar</material-checkbox>
        </div>
      </div>
      <div class="mb-3 mt-3 ms-3">
        <p ref="Clausula9" :contenteditable="store.clausula9edit" class="text-justify">
...
export default {
  ...
  watch: {
    'this.$refs.Clausula9': {
      handler(newVal) {
        if (newVal) {
          this.store.clausula9 = newVal.innerText;
        }
      },
      deep: true,
      immediate: true
  ...
  mounted() {
    if (this.$refs.Clausula9) {
      this.store.clausula9 = this.$refs.Clausula9.innerText;
    }
  }
}
</script>