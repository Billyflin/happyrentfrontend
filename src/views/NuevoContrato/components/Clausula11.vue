  ...
  <div class="row align-items-center">
    <div class="col-9">
      <div class="row">
        ...
        <div class="col-2">
          <material-checkbox id="editClausula11" v-model="store.clausula11edit">Editar</material-checkbox>
        </div>
      </div>
      <div class="mb-3 mt-3 ms-3">
        <p ref="Clausula11" :contenteditable="store.clausula11edit" class="text-justify">
...
export default {
  ...
  watch: {
    'this.$refs.Clausula11': {
      handler(newVal) {
        if (newVal) {
          this.store.clausula11 = newVal.innerText;
        }
      },
      deep: true,
      immediate: true
  ...
  mounted() {
    if (this.$refs.Clausula11) {
      this.store.clausula11 = this.$refs.Clausula11.innerText;
    }
  }
}
</script>