  ...
  <div class="row align-items-center">
    <div class="col-9">
      <div class="row">
        ...
        <div class="col-2">
          <material-checkbox id="editClausula1" v-model="store.clausula1edit"
      ...
      <div class="mb-3 mt-3 ms-3">
        <p ref="Clausula1" :contenteditable="store.clausula1edit" class="text-justify">
          ...
          {{ store2.propiedad.direccion.calle }} {{ store2.propiedad.direccion.numero }}, comuna de
          {{ store2.propiedad.direccion.ciudad }}, {{ store2.propiedad.direccion.region }},
          {{ store2.propiedad.direccion.pais }}. Esta propiedad se da en arrendamiento a la
          arrendataria, quien acepta su uso exclusivo para fines
