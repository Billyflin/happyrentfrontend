  ...
  <div class="container-fluid mt-4">
    <div class="row mb-4">
      <div class="col-lg-8">
        ...
        <p>
          Puedes agregarla manualmente o solicitarle al futuro arrendatario que complete un
          formulario para agregarla a tu lista de personas.
        </p>
      </div>
      ...
      <div class="col-lg-12">
        <div class="card p-3">
          <div class="pb-0 card-header d-flex align-items-center justify-content-between">
            ...
            >
              Agregar persona
              <span class="material-symbols-outlined mx-2"> person_add </span>
            </router-link>
          </div>
          <tabla-personas
            :details="true"
