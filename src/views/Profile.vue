      ...
      <div class="row gx-4">
        <div class="col-auto">
          <div class="avatar avatar-xl position-relative">
            <img src="@/assets/img/Billyflin.jpg" alt="profile_image" class="shadow-sm w-100 border-radius-lg" />
          </div>
        </div>
          ...
          <div class="col-12 col-md-6 col-xl-4 position-relative">
            <div class="card card-plain h-100">
              <div class="p-3 pb-0 card-header">
                <h6 class="mb-0">Ajustes de la plataforma</h6>
              </div>
              <div class="p-3 card-body">
                <h6 class="text-xs text-uppercase text-body font-weight-bolder">Cuenta</h6>
                <ul class="list-group">
                  <li class="px-0 border-0 list-group-item">
                    <material-switch
                      ...
                      checked
                      >Notificarme envío</material-switch
                    >
                  </li>
                  <li class="px-0 border-0 list-group-item">
                    <material-switch
                      ...
                      label-class="mb-0 text-body text-truncate w-80"
                      >Recibir novedades y ofertas por correo</material-switch
                    >
                  </li>
                  ...
                  <li class="px-0 border-0 list-group-item">
                    <material-switch
                      ...
                      label-class="mb-0 text-body text-truncate w-80"
                      checked
                      >Configuracion extra</material-switch
                    >
                  </li>
                </ul>
              </div>
