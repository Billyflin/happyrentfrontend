  ...
  <div class="container-fluid mt-4">
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        ...
        <propiedad-agregar-propietario
          class="mt-4"
          @update:propietario="
            propiedad.propietario = $event
            console.log($event)
          "
        />
  ...
  methods: {
    async emitData() {
      ...
      if (!this.v$.$error) {
        ...
        formData.append(
          'propiedad',
          new Blob([JSON.stringify(this.propiedad)], { type: 'application/json' })
        )
        ...
        try {
          ...
          this.store4.createNotification(
            'danger',
            'Error',
            'Hubo un error al guardar la propiedad' + error
          )
          console.log(error)
        }
      }
