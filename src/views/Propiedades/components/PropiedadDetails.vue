<template>
  <div class="container-fluid">
    ...
    <div v-else class="row">
      <div class="col-lg-6">
        <div v-if="datosPropiedad" class="card">
          <div class="card-body">
            <div class="image-section">
              <img
                :src="'data:image/png;base64,' + datosPropiedad.imagenPortada.contenido"
  ...
  methods: {
    ...
    async updateDatosPropiedad(datosPropiedad) {
      ...
      try {
        ...
        this.showAlert(
          'Error al actualizar los datos de la propiedad: ' + err.response.data,
          'error'
        )
