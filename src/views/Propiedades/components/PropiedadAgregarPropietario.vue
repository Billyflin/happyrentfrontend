...
<template>
  <div id="Propietario" class="card">
    <div class="card-header">
      ...
      <p>
        Acá puedes seleccionar de los propietarios previamente registrados, en caso de no tener
        ninguno debes ir a la pestaña
      ...
      <div class="row">
        <div class="col-12 mb-4">
          <material-choices
            ...
            label="Selecciona un propietario existente"
        ...
        <div v-if="propietario_existente">
          <div v-if="propietario_existente.value.type === 'persona'" class="col">
            ...
            <div
              v-if="propietario_existente.value.direccion"
              class="d-flex justify-content-between align-items-center"
            >
              <h6 class="font-weight-normal">Dirección</h6>
              <p class="text-capitalize">
                {{ propietario_existente.value.direccion.calle }},
                {{ propietario_existente.value.direccion.numero }},
                {{ propietario_existente.value.direccion.detalle }},
                {{ propietario_existente.value.direccion.ciudad }},
                {{ propietario_existente.value.direccion.region }},
                {{ propietario_existente.value.direccion.pais }}
              </p>
            </div>
          </div>
