  ...
  <div :class="['card', { 'border-danger animate__animated animate__shakeX': contratoError }]">
    <div class="card-header d-flex justify-content-between align-items-center">
      <div>
        ...
        <p class="mx-2 mt-4">
          Acá puedes seleccionar al codeudor previamente registrados, en caso de no tener registrado
          puedes agregar uno termporal o agregar uno nuevo en la pestaña
        ...
        <div v-if="propietario_existente.value.type === 'persona'" class="col">
          ...
          >
            ...
            <p class="text-capitalize">
              ...
              {{ propietario_existente.value.ciudad }} , {{ propietario_existente.value.region }},
              {{ propietario_existente.value.pais }}
            </p>
          </div>
        </div>
