    ...
    <div class="card-body pt-0">
          <div class="d-flex justify-content-between">
            <div>
              ...
              <h2 class="mb-0">{{ formatCurrency(getTotalAmount(), moneda) }} {{getCurrencyCode(moneda)}}</h2>
            </div>
          </div>
          <div class="d-flex justify-content-between mt-4">
            ...
            <div>
              ...
              <h5>{{ fechaTermino? formatDate(fechaTermino):" Sin fecha registrada (Contrato vigente)" }}</h5>
            </div>
          </div>
          <div class="d-flex justify-content-between mt-4">
            <div>
              <h6 class="text-muted font-weight-normal mb-0">Garantía {{garantia===1 ? '(1 mes)': `${garantia} meses`}}</h6>
          ...
          <div class="d-flex justify-content-between mt-4">
            ...
            <div>
              <h6 class="text-muted font-weight-normal mb-0">Fecha de creación del contrato en la plataforma</h6>
