...
const submitForm = async () => {
  ...
  sending.value = true
  try {
    await solicitarDatosCorreo( email.value, carnet.value, liquidaciones.value, certificadoAFP.value, certificadoDicom.value, carpetaTributaria.value, contratoTrabajo.value).then(() => {
        enviado.value = true
