        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card mt-8 mb-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              ...
              >
                <h4 v-if="!state" class="font-weight-bolder text-white mt-1">
                  Olvidó su contraseña
                </h4>
                <h3 v-else class="font-weight-bolder text-white mt-1">Correo enviado</h3>
                <p v-if="!state" class="mb-1 text-white text-sm">
...
const submitForm = () => {
  ...
  axios
    .post(
      `${import.meta.env.VITE_SERVER_URL}:${import.meta.env.VITE_SERVER_PORT}/api/v1/auth/forgot-password-email`,
      {
