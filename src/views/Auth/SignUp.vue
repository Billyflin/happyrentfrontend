                ...
                <div class="card card-plain">
                  ...
                  <div class="card-body">
                    <form role="form" @submit.prevent="submitForm">
                      ...
                      >
                        Acepto los
                        <a class="text-dark font-weight-bolder" href="">Términos y Condiciones</a>
                      </material-checkbox>
                      <div v-if="acceptVerification" class="row mb-3 mt-3">
                        <span class="badge badge-danger"
                          >Acepta los términos y condiciones para continuar</span
                        >
                      </div>
...
const submitForm = () => {
  ...
  axios
    .post(
      `${import.meta.env.VITE_SERVER_URL}:${import.meta.env.VITE_SERVER_PORT}/api/v1/auth/register`,
      user
    )
    .then((response) => {
