...
export function activateDarkMode() {
  ...
  const selectors = [
    ...
    { selector: 'span.text-dark, .breadcrumb .text-dark', classRemove: 'text-dark', classAdd: 'text-white' },
    ...
    { selector: '.text-secondary', classRemove: 'text-secondary', classAdd: 'text-white', extraClassAdd: 'opacity-8' },
    ...
    { selector: '.main-content .container-fluid .card', classRemove: 'blur', extraClassRemove: 'shadow-blur' }
  ]
...
export function deactivateDarkMode() {
  ...
  const selectors = [
    ...
    { selector: 'button:not(.btn) > .text-white', classRemove: 'text-white', classAdd: 'text-dark' },
    {
    ...
    { selector: 'a.nav-link.text-white', classRemove: 'text-white', classAdd: 'text-dark', exclude: ['.sidenav'] },
    { selector: '.text-white', classRemove: 'text-white', classAdd: 'text-dark', extraClassRemove: 'opacity-8' },
    ...
    { selector: '.main-content .container-fluid .card', classAdd: 'blur', extraClassAdd: 'shadow-blur' }
  ]
